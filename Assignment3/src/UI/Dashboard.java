   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        tab_stud.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr. No.", "Student Name", "Student ID", "GPA", "Department", "School", "Employement Status", "Year of Graduation", "Employer Rating"
            }
        ));
    ...
    private void clg_dropActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clg_dropActionPerformed
        ...
        int[] stud_grad={2014,2015,2016,2017};
        int[] rate={1,2,3,4,5};
        String[] test={"1int","2","3","4","5","4","4","4"};
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JFreeChart barchart=ChartFactory.createBarChart("College Employement Percentage", "Department","Status", bardata,PlotOrientation.VERTICAL,false,true,false);
        CategoryPlot barchrt= barchart.getCategoryPlot();
        barchart.setBackgroundPaint(Color.WHITE);
        barchrt.setRangeGridlinePaint(Color.GREEN);
        ChartFrame frame1=new ChartFrame("count",barchart);
