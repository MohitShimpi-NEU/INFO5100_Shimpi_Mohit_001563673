...
public class AdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(userJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 240, 230, -1));
        ...
        add(manageEmployeeJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, 230, -1));
        ...
        add(manageOrganizationJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 140, 230, -1));
        ...
        add(valueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 90, 160, 20));
    }// </editor-fold>//GEN-END:initComponents

    private void userJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_userJButtonActionPerformed
        // TODO add your handling code here:
        ManageRestaurantInfoJPanel manageres = new ManageRestaurantInfoJPanel(userProcessContainer,account, ecoSystem, restaurantDirectory);
        userProcessContainer.add(manageres);
    ...
    private void manageEmployeeJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageEmployeeJButtonActionPerformed
        ...
        ManageMenuJPanel managemenu = new ManageMenuJPanel(userProcessContainer,account, ecoSystem, restaurantDirectory,menuDirectory);
        userProcessContainer.add(managemenu);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void manageOrganizationJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageOrganizationJButtonActionPerformed
        ...
        ManageOrderJPanel manageorder = new ManageOrderJPanel(userProcessContainer,account, ecoSystem, restaurantDirectory,menuDirectory, orderDirectory);
