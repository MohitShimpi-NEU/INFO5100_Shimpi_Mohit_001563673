...
public class DeliveryManDirectory {
    ...
    public DeliveryMan newDeliveryMan(String name, String address, String email, String phoneNumber) {
        DeliveryMan deliveryMan = new DeliveryMan(name, address, email, phoneNumber);
