...
public class facultyLoginPanel extends javax.swing.JPanel {
    ...
    JSplitPane temp;
    MainClass main;
    public facultyLoginPanel(MainClass main, JSplitPane S) {
        this.main=main;
        this.temp =S;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        facultyControlPanel facultyControl = new facultyControlPanel(main);
        temp.setRightComponent(facultyControl);
